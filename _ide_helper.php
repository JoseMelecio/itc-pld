...
namespace Illuminate\Support\Facades {
     ...
     */        class Auth {
         ...
         */        public static function id()
        {
                    ...
                    /**
         * SystemLog a user into the application without sessions or cookies.
         *
         ...
         */        public static function once($credentials = [])
        {
                    ...
                    /**
         * SystemLog the given user ID into the application without sessions or cookies.
         *
         * @param mixed $id
         ...
         */        public static function attemptWhen($credentials = [], $callbacks = null, $remember = false)
        {
                    ...
                    /**
         * SystemLog the given user ID into the application.
         *
         * @param mixed $id
         * @param bool $remember
         * @return \App\Models\User|false
         ...
         */        public static function loginUsingId($id, $remember = false)
        {
                    ...
                    /**
         * SystemLog a user into the application.
         *
         ...
         */        public static function login($user, $remember = false)
        {
                    ...
                    /**
         * SystemLog the user out of the application.
         *
         * @return void
         * @static
         */        public static function logout()
        {
                    ...
                    /**
         * SystemLog the user out of the application on their current device only.
         *
     ...
     */        class DB {
        ...
        {            //Method inherited from \Illuminate\Database\Connection
                    ...
                    /**
         * SystemLog a query in the connection's query log.
         *
         * @param string $query
         * @param array $bindings
