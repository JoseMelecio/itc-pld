    ...
    */
    public function collection(Collection $collection): void
    {
        ...
        foreach ($collection->skip(3) as $row) {
            ...
            $m_domicilioNacionalPersonaAviso = array(
            ...
            $m_domicilioInternacionalPersonaAviso = array(
            ...
            $m_caracteristicasInmueble = array(
